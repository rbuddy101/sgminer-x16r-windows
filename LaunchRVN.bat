...
sgminer.exe -k x16r -o stratum+tcp://pool.ominousnetwork.com:3636 -u RWoSZX6j6WU6SVTVq5hKmdgPmmrYE9be5R -p x -I 19 --gpu-platform=1 --gpu-engine 1200 --gpu-memclock 2100 --thread-concurrency 1024
pause
